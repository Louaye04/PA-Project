...
exports.updateProduct = (productId, sellerId, updates) => {
  ...
  if (products[index].sellerId !== sellerId) {
    const error = new Error('Non autorisé: Vous n\'êtes pas le propriétaire de ce produit');
...
exports.decrementStock = (productId, quantity = 1) => {
  ...
  console.log('📦 [Products] Stock mis à jour:', productId, 'nouveau stock:', products[index].stock);
